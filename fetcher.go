...
//	return  t.AddDate(0,0,5).String()[:10]
	 return dates
...
for i := 0;  i<len(city); i++ {
	...
	url := "http://api.apixu.com/v1/forecast.json?key=41dba5f315b740348dd111839190807&q="+city[i]+"&dt="+dates[j]
	weather, err := readJSONFromUrl(url)
	fmt.Println("fetching: ",city[i],dates)
	if err != nil {
		fmt.Println(err)
	}
